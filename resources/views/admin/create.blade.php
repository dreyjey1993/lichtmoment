...
<div class="pt-24 sm:pt-28 pb-12 px-4 sm:px-6">
    <div class="max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.project.create') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-100 p-5 sm:p-6 space-y-5">
                <div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-lg p-6 text-center hover:border-gold-300 hover:bg-gold-50/30 transition-colors" id="cover-dropzone">
                    ...
                    <div id="cover-preview" class="hidden mt-3">
                        <img src="" alt="Vorschau" class="w-full max-h-48 object-cover rounded-lg border border-gray-200">
                        <button type="button" onclick="removeCover()" class="text-xs text-red-400 hover:text-red-600 mt-1">Entfernen</button>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="inline-flex items-center gap-2 px-6 py-2.5 bg-gold-400 hover:bg-gold-500 text-white text-sm font-medium rounded-xl transition-colors">
